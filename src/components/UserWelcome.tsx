...
function UserWelcomeSkeleton() {
  return (
    <div className="h-[160px] bg-background px-0 sm:px-6 py-4 rounded-2xl flex sm:flex-col sm:justify-end gap-4">
      <div className="size-12 sm:size-16 shrink-0 rounded-full bg-gray-200 animate-pulse" />
      <div className="flex-1">
        <div className="h-4 sm:h-5 w-32 bg-gray-200 rounded animate-pulse mb-2" />
        <div className="h-6 sm:h-8 w-48 bg-gray-200 rounded animate-pulse" />
      </div>
    </div>
  );
}
